            ...
            <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                <a href="{{ url(''); }}" class="text-decoration-none d-block d-lg-none">
                    ...
                    <div style="display: flex;">
                        ...
                        <a href="https://live-x-martplace.com/my_wishlist" class="btn px-0">
                            <i class="fas fa-heart text-primary"></i>
                            <span class="badge text-secondary border border-secondary rounded-circle" style="padding-bottom: 2px;">1</span>
                        </a>
                        <a href="https://live-x-martplace.com/cart" class="btn px-0 ml-3">
                            <i class="fas fa-shopping-cart text-primary"></i>
                            <span class="badge text-secondary border border-secondary rounded-circle" style="padding-bottom: 2px;" id="cartValue">0</span>
                        </a>
                    </div>
